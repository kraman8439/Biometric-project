...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\stimag.jpg")
        img=img.resize((500,130),Image.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=500,height=140)


        # second image
        img1=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\stuimag.jpg")
        img1=img1.resize((1000,130))
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=500,y=0,width=500,height=140)


        #third image
        img2=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\studentimg.jpg")
        img2=img2.resize((500,130),Image.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)

        f_lbl=Label(self.root,image=self.photoimg2)
        f_lbl.place(x=1000,y=0,width=550,height=140)


        #bg  image
        img3=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\3b1d1d94c67840cc9a097fac01757a4c.jpeg")
        ...
        img_left=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\gettyimages.jpg")
        ...
        current_course_frame.place(x=5,y=135,width=740,height=120)
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT","AIML","ME")
        dep_combo.current(0)
        ...
        btn_frame.place(x=0,y=180,width=735,height=45)
        ...
        btn_frame1.place(x=0,y=210,width=735,height=45)
        ...
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\91843\Desktop\Face Reconition Using Python\Images\photo-1571260899304-425eee4c7efc.jpeg")
        ...
        # ======Search System=============
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Class Student information",font=("times new roman",13,"bold"))
